...
function() {
    ...
    function b() {
            ...
            return {
                eventBind: function() {
                   ...
                   /* $("#J_common_header_menu .menu-dropdown-content").mouseenter(function(a) {
                    ...
                    $(document).on("mouseenter","#J_common_header_menu .menu-dropdown-content",function(a){
                    	d && (clearTimeout(d), d = null)	
                    })
                },
                initStatus: function() {
      ...
      /*  $("#J_common_header_menu .top-menu-item").mouseenter(function() {
        	...
        	*/
        $(document).on("mouseenter","#J_common_header_menu .top-menu-item",function(){
        	 var a, b = null,
             c = $(this); (a = c.data("mouseoutTimer")) && (clearTimeout(a), a = null),
             c.data("enterTime", (new Date).getTime()),
             b = setTimeout(function() {
       ...
       /* $("#J_common_header_menu .top-menu-item").mouseleave(function(a) {
            var c = $(this),
        ...
        $(document).on("mouseleave","#J_common_header_menu .top-menu-item",function(a){
            var c = $(this),
            d = parseInt(c.data("enterTime") || 0, 10),
            e = (new Date).getTime(),
            f = c.data("mouseoverTimter");
    ...
    function c(a, b, c, d) {
        ...
        var f;
        d.length && (f = d.attr("activity-url")) && 0 == d.find("a").length && d.append('<a style="opacity: 0;filter: alpha(opacity=0);" href="' + f + '" target="_blank">阿里云</a>'),
    ...
    window.jQuery ? e() : a("//g.alicdn.com/aliyun/www-dpl/0.3.32/knight/js/base-all.js",
    function() {
        e()
    })
} ();